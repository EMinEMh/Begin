...
class Article(BaseModel):
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name='作者', null=False, blank=False, on_delete=models.CASCADE)
    author_order = models.IntegerField('排序,数字越大越靠前', null=False, blank=False, default=0)
    category = models.ForeignKey('Category', verbose_name='分类', null=False, blank=False, on_delete=models.CASCADE)
    ...
    class Meta:
        ordering = ['-author_order', '-pub_time']
        verbose_name = "文章"
...
class Tag(BaseModel):
    ...
    slug = models.SlugField(default='no-slug', max_length=60, unique=True)
...
class BlogSettings(models.Model):
    ...
    site_describe = models.TextField('网站描述', max_length=1000, null=False, blank=False, default='')
    site_seo_describe = models.TextField('网站SEO描述', max_length=1000, null=False, blank=False, default='')
